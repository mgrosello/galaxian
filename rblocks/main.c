...
int main(void)
{
    ...
    prtime();
    puts("rblocks - an open source, cross-platform arcade game written in C");
    prtime();
    puts("Written by sigkill for rcode. Built on " __DATE__ " at " __TIME__);
